...
$$
E_r < 0.5\times10^{-t}\Rightarrow \frac{|x-\tilde{x}|}{|x|}<0.5\times10^{-t+1}
$$
...
\begin{frame}
  ...
  \begin{center}
    \begin{tabular}{|c|c|c|}\hline
      \textbf{Precisi\'on} & \textbf{Bits Mantisa} & \textbf{\'Epsilon de la M\'aquina}\\\hline
      Simple & 23 & $1.19\times10^{-7}$\\\hline
      Doble & 52 & $2.22\times10^{-16}$\\\hline
    \end{tabular}
  \end{center}}
\end{frame}
%%%%
...
\begin{frame}{Conclusiones: Teor\'ia de Errores}
    \begin{itemize}
      \item \textbf{Errores Inevitables}: Debido a la precisión finita del hardware.
      \item \textbf{Conocimiento es Poder}: Entender las fuentes de error permite diseñar mejores algoritmos.
      \item  \textbf{Estabilidad Crucial}: Es fundamental para obtener resultados confiables en cálculos iterativos.
    \end{itemize}
    \vspace{0.5cm}
    \begin{center}
      \it{``El análisis de errores es una herramienta práctica esencial para ingenieros y cient\'ficos.''}
    \end{center}
\end{frame}
\end{document}