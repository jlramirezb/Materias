...
\begin{frame}{Uso de Bibliograf\'ia}
  \begin{itemize}
    ...
    \begin{block}{}
      \footnotesize
      \texttt{\color{blue}
      \textbackslash begin\{thebibliography\}\{99\} --> para poder incluir hasta 999 citas\\
      \textbackslash bibitem\{ref1\} Titulo, autor, año, etc\ldots\\
       \textbackslash bibitem\{ref2\} Titulo, autor, año, etc\ldots\\
        \ldots\\
        \textbackslash end\{thebibliography\}}
    \end{block}
    \item Para citar referencias en el texto del documento, se utiliza el comando \texttt{\color{blue}cite\{etiqueta\}}, donde etiqueta se debe corresponder con la etiqueta de la entrada bibitem a referenciar.
  \end{itemize}
\end{frame}
\end{document}