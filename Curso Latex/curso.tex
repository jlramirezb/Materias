...
%%%%%%
 ...
 para mostrarlo en un entorno diferente.
   ...
   \end{columns}    
     \vskip 2ex
   \item Note como el $\Sigma$ es más grande en el entorno \texttt{equation}, y como el subíndice y superíndice cambian de
...
\begin{frame}[fragile]{Ejemplos con \texttt{\color{green}amsmath}}
  \begin{itemize}{\small
    ...
    \item El ampersand \texttt{\&} separa la columna izquierda (antes del $=$) de la columna derecha (después del $=$).
    \begin{center}
...
\begin{frame}[fragile]{Etiquetas y Referencias Cruzadas}
  \begin{itemize}
    \item Utilice {\color{blue}\texttt{label}} y {\color{blue}\texttt{ref}} para la numeración automática.
    \item El paquete {\color{blue}\texttt{amsmath}} proporciona {\color{blue}\texttt{eqref}} para las referencias de ecuaciones.
    \end{itemize} 
\begin{tabular}{lc}
