...
\begin{array}{r}
v^{(0)} = r^{(0)} = b - Ax^{(0)}\\
t_0 = \displaystyle\frac{r^{(0)}\cdot v^{(0)}}{(v^{(0)})^TAv^{(0)}}\\
x^{(1)} = x^{(0)} + t_0v^{(0)}\\
r^{(1)} = b -Ax^{(1)}\\
\alpha_0 = -\displaystyle\frac{(v^{(0)})^TAr^{(1)}}{(v^{(0)})^TAv^{(0)}}\\
v^{(1)}=r^{(1)}+\alpha_0r^{(0)}\\
\vdots\\
t_i = \displaystyle\frac{r^{(i)}\cdot v^{(i)}}{(v^{(i)})^TAv^{(i)}}\\
x^{(i+1)} = x^{(i)} + t_iv^{(i)}\\
r^{(i+1)} = b -Ax^{(i+1)}\\
\alpha_i = -\displaystyle\frac{(v^{(i)})^TAr^{(i+1)}}{(v^{(i)})^TAv^{(i)}}\\
