...
\begin{enumerate}
  ...
  \item Sean $v_1 = (1; \alpha; \alpha^2)$, $v_2 =(1; \beta; \beta^2)$ y $v_3 =(1; \gamma; \gamma^2)$ tres vectores de $\mathbb{R}^3$, donde $\alpha$, $\beta$ y $\gamma$ son n\'umeros reales distintos de cero. Que condiciones deben cumplir los n\'umeros $\alpha$, $\beta$ y $\gamma$ para que los tres vectores $v_1, v_2$ y $v_3$ sean linealmente independientes.
...
0 & -1
  ...
  $$
  \item Encuentre una base y la dimensión del subespacio $W$ de $\mathbb{R}^4$, que consta de todos los vectores de
